...
def loginWindow():
    titleLabel = Label(window,text="Union Relief Chart",font="Arial 40",fg="green")
...
def mainwindow():
    ...
    titleLabel = Label(window,text="Union Relief Program",font="Arial 30",fg="green")
    titleLabel.grid(row=0,column=1,columnspan=3,pady=(10,0))

    addNewItem = Button(window, text="Add Consumer", width=15, height=2, command=lambda: addItemListener())
    addNewItem.grid(row=1, column=0, padx=(10,0),pady=(10,0))
    updateItem = Button(window, text="Goods", width=15, height=2,command=lambda: moveToUpdate())
    updateItem.grid(row=1, column=1, padx=(10,0), pady=(10,0))

    showallEntry= Button(window, text="show chart", width=15, height=2,command=lambda:movetoBills())
    ...
    itemLabel = Label(window, text="Select Goods")
    ...
    rateLabel= Label(window, text="Govt.Rate")
    ...
    quantityLabel = Label(window, text="Quantity(kg)")
    ...
    buttonBill = Button(window, text="+ consumer List", width =15,command=lambda:generate_bill())
    buttonBill.grid(row=3, column=4,padx=(5,0),pady=(10,0))

    billLabel=Label(window, text="UP SLIP", font="Arial 25")
